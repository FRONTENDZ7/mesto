export class Card {
  constructor(cardElement, elementTemplate, userId, authorData, handleActions) {
    this._card = cardElement;
    this._cardName = this._card.name;
    this._cardImage = this._card.link;
    this._cardTemplate = elementTemplate;
    this._userId = userId;
    this._cardId = authorData.cardId;
    this._authorId = authorData.authorId;
    this._cardZoom = handleActions.makeCardZoom;
    this._cardDelete = handleActions.makeCardDelete;
    this._putLike = handleActions.makeCardLike;
    this._removeLike = handleActions.makeCardDeleteLike;
  }
